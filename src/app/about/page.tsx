    ...
    <div className="w-screen bg-HeroBackground">
        <div className="mx-auto w-screen max-w-[1440px]">
            ...
            <div className="bg-carouselBackground w-full">
                <h1 className="bg-gradient-to-r from-[#445DB6] to-[#7860C5] text-transparent bg-clip-text text-2xl lg:text-3xl pt-[120px] text-center font-bold">PREVIOUS EDITION</h1>
                <p className="text-[#143A81] w-[85%] lg:w-[80%] mx-auto lg:text-lg mt-4 pb-4" 
                    style={{
                        wordWrap: 'break-word',
                        whiteSpace: 'pre-line',
                        textAlign: 'justify', 
            ...
            <div className="bg-HeroBackground w-full relative">
                ...
                ></Image> */}
                <div className="flex w-[95%] lg:w-[80%] mx-auto pt-12 gap-2 lg:gap-16 pb-[70px]">
                    <div>
            ...
            <div className="w-full bg-carouselBackground">
                ...
                <div className="flex w-[95%] lg:w-[80%] mx-auto gap-2 lg:gap-12 pb-[70px] text-[#143A81]" 
                    style={{
                        wordWrap: 'break-word',
                        whiteSpace: 'pre-line',
                        textAlign: 'justify', 
            ...
            <div className="bg-HeroBackground w-full relative">
                ...
                <div className="flex gap-8 items-center justify-center px-4 py-16 z-20">
                    <Link href="">
                        <Image
