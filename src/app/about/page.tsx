  ...
  return (
    ...
    <div className="w-screen bg-HeroBackground max-w-full">
        <div className="mx-auto w-full overflow-x-hidden">
            <div className="relative w-full h-[40vh] md:h-[70vh] lg:h-screen 4xl:h-[80vh] 4xl:max-h-[900px] overflow-hidden max-w-[1920px] mx-auto ">
                {/* top gradient*/}
            ...
            <div className="bg-[#D7E1E3] w-full">
                <h1 className="bg-textBG text-transparent bg-clip-text text-2xl lg:text-3xl pt-[120px] text-center font-bold 3xl:text-[2vw] 4xl:text-3xl">PREVIOUS EDITION
                <br />
