...
export const formValidationSingleDelegate = Yup.object({
	...
	year: Yup.number().max(6, '<6').min(1, '>1').required('Required'),
...
export const formValidationDoubleDelegate = Yup.object({
	...
	s_year: Yup.number().max(6, '<6').min(1, '>1').required('Required'),
	d_year: Yup.number().max(6, '<6').min(1, '>1').required('Required'),
	...
	accommodation: Yup.string().required('Required'),
	accommodation_type: Yup.string().oneOf(['Male', 'Female', 'Other']),
	committeeOne: Yup.string().required('Required'),
	committeeOne_countryOne: Yup.string().required('Required'),
	committeeOne_countryTwo: Yup.string().required('Required'),
	committeeOne_countryThree: Yup.string().required('Required'),
