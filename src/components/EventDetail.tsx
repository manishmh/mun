  ...
  return (
    <div className="flex gap-2 sm:gap-4 xl:gap-8 items-center">
        ...
        <div>
            ...
            <button className="outline-none mt-2 md:mt-3.5 border-none pb-1 font-medium text-sm md:py-1 px-4 bg-buttonBackground rounded-full">Not yet Announced</button>
        </div>
    </div>
  )
};
