					...
					{carouselData.map(n => <div className='flex h-full w-full items-center justify-center' key={n.id}>
						<div className='h-full w-full'>
							<div className='flex h-full justify-between md:mx-24 items-center'>
								...
								<Image src={`/carousel/${n.image}`} width={300} height={300} alt='carousel image' className={'w-[250px] h-[250px] lg:w-[300px] lg:h-[300px]'} />
							</div>
						</div>
					</div>
					)}
