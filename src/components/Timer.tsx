  ...
  return (
    <>
      <div className="font-sans h-[90vh] w-screen overflow-hidden bg-[#E2DDF4] pt-12">
        <h1 className="pb-5 flex items-center justify-center text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#061124] via-[#143A81] to-[#061125]">
      ...
      <div className="px-10 flex justify-center text-[#7691C0] text-2xl">
        <span>DAYS</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span>HOURS </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span>MINUTES </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span>SECONDS </span>
      </div>
      <div className="px-10 flex justify-evenly text-[#143A81] text-2xl">
        <span><TiCalendarOutline></TiCalendarOutline>July 11-12-13, 2023</span>
        <span><TiLocation></TiLocation>KIIT Bhubaneswar</span>
      </div>
