...
const Hero = () => {
  return (
    <>
    <div className="font-sans w-screen bg-HeroBackground overflow-x-hidden z-[-10] h-screen md:h-auto">
      <Image
      ...
      <div className="relative max-w-[1440px] mx-auto">
        <div className="flex flex-col md:flex-row justify-around relative md:items-center h-full">
            <Image
              ...
              height={720}
              quality={100}
              className="h-[50vh] w-[100%] mx-auto sm:w-[75%] -translate-y-[30px] md:w-[55%] sm:h-[500px] md:h-[550px] lg:h-[700px] flex-shrink-0 max-w-[700px]"
          ...
          <div className="flex-col bg-green-900 w-full text-center md:text-justify hidden -translate-y-[400px] md:-translate-y-0 md:-translate-x-[40px] lg:-translate-x-0 justify-center gap-3 text-white">
            <h1 className="sm:text-2xl text-2xl lg:text-3xl font-bold">
            ...
            <p className="max-w-[900px] text-sm w-[80%] text-center mx-auto md:w-[80%]"
             style={{ 
              wordWrap: 'break-word',
              whiteSpace: 'pre-line',
              textAlign: 'justify', 
      ...
      <div className="relative max-w-[1440px] mt-[70px] mx-auto  md:px-[5vw] xl:px-[100px] pt-8 text-3xl text-white first-letter">
        <div className="flex flex-col md:flex-row -translate-y-[100px] md:-translate-y-0 items-center justify-between w-full lg:pr-[150px] md:pr-[100px] sm:pr-[50px] xl:pr-[200px] absolute top-0 md:top-10">
          <div className="w-[90%] md:w-[40%]">
            ...
            <div className="md:hidden flex gap-2 text-lg font-bold justify-center md:justify-normal">
              See more about us
              <Link href="/about" className="flex items-center">
                <span className="inline-block rounded-full bg-white px-1 py-1 text-xs text-black">
                  <FaArrowRight></FaArrowRight>
            ...
            <div className="flex justify-center md:justify-normal">
              <Link href="#footer" className="z-50">
                <button className="mt-1 md:mt-5 rounded-full border-none bg-buttonBackground px-8 py-1 text-base outline-none">
                  CONTACT US
                </button>
              </Link>
            </div>
          </div>
          <div className="flex text-[40px] z-40 mt-4">
            <Link href="/">
            {/* target="_blank" */}
